  ...
  const fetchData = async () => {
    ...
    try {
      const [projectsRes, statsRes] = await Promise.all([
        projectsApi.list({ status: "all" }), // NGOs should see all their projects
        statsApi.ngo(),
      ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-start">
            ...
            <button className="px-6 py-3 rounded-lg bg-primary text-white hover:bg-primary/90 transition-all flex items-center gap-2 font-semibold">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex gap-3">
                        <button
                          ...
                          className="flex-1 px-4 py-3 rounded-xl bg-accent/20 text-primary hover:bg-accent hover:text-white transition-all text-sm font-bold flex items-center justify-center gap-2 border border-accent/20"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 px-4 py-3 rounded-xl border-2 border-primary/20 text-primary hover:bg-primary/5 transition-all text-sm font-bold flex items-center justify-center gap-2"
                        >
          ...
          <div className="bg-white rounded-xl border border-green-100 p-8">
            <div className="text-center space-y-4">
              <h3 className="text-2xl font-bold text-primary">
                Milestone-Based Funding Requests
              </h3>
              <p className="text-gray-600">
                Request funds as you complete project milestones
              </p>
        ...
        {activeTab === "volunteers" && (
          <div className="bg-white rounded-xl border border-green-100 p-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                Track volunteers and their contributions
              </p>
              <button className="px-6 py-3 rounded-lg bg-primary text-white hover:bg-primary/90 transition-all font-semibold mt-4">
                View All Volunteers
              </button>
