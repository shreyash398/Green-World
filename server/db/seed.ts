...
async function seed() {
    ...
    const projectData = [
        ...
        {
            title: "Odisha Turtle Protect",
            description: "Safeguarding Olive Ridley nesting sites on the Gahirmatha coast.",
            longDescription: "Protecting thousands of nesting turtles and their hatchlings through beach patrolling and community-led conservation efforts.",
            location: "Odisha, India",
            fundingGoal: 45000,
            fundingReceived: 28000,
            status: "active" as const,
            impactType: "Waste",
            impactValue: "10,000 nests",
            carbonOffset: "0.5 tons/year",
            image: "🐢",
            ngoId: ngos[1].id,
        },
        {
            title: "Air Quality Watch",
            description: "City-wide deployment of low-cost air quality sensors for real-time monitoring.",
            longDescription: "Empowering citizens with data to advocate for cleaner air. We've deployed 100 sensors across Delhi-NCR to map pollution hotspots.",
            location: "Delhi, India",
            fundingGoal: 20000,
            fundingReceived: 15000,
            status: "active" as const,
            impactType: "Energy",
            impactValue: "100 sensors",
            carbonOffset: "N/A",
            image: "🌫️",
            ngoId: ngos[2].id,
        },
        {
            ...
            description: "Preserving indigenous crop varieties through community-run seed banks.",
            longDescription: "Supporting 500 smallholder farmers in Himachal Pradesh to conserve and exchange heirloom seeds resistant to climate change.",
            location: "Himachal Pradesh, India",
            fundingGoal: 35000,
            fundingReceived: 35000,
            status: "completed" as const,
            impactType: "Trees",
            impactValue: "500 varieties",
            image: "🌱",
            ngoId: ngos[0].id,
        },
        {
            title: "Bangalore Textile Loop",
            description: "Implementing a circular system for textile waste in the garment hub.",
            longDescription: "Collecting and upcycling 10 tons of fabric waste monthly from textile factories in Bangalore to reduce landfill impact.",
            location: "Bangalore, India",
            fundingGoal: 55000,
            fundingReceived: 12000,
            status: "active" as const,
            impactType: "Waste",
            impactValue: "10 tons/mo",
            carbonOffset: "2.5 tons/year",
            image: "👕",
            ngoId: ngos[1].id,
        },
        {
            title: "Solar Irrigation Pumps",
            description: "Providing solar-powered irrigation to off-grid farms in Maharashtra.",
            longDescription: "Replacing diesel pumps with clean solar energy for 200 small-scale farmers, reducing operational costs and carbon emissions.",
            location: "Maharashtra, India",
            fundingGoal: 80000,
            fundingReceived: 45000,
            status: "active" as const,
            impactType: "Energy",
            impactValue: "200 pumps",
            carbonOffset: "4.8 tons/year",
            image: "☀️",
            ngoId: ngos[2].id,
        }
    ];
